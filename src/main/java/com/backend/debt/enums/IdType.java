...
public enum IdType {
  ...
  IdType(String code, String displayName, boolean isOrganization) {
    this.code = code;
  ...
  // 智能解析方法（带容错处理）
  public static IdType fromInput(String input) {
  ...
  private static IdType parseByDisplayName(String cleanValue) {
