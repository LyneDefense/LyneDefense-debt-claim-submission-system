 ...
 * Web配置类
 *
 * <p>该类用于配置Web相关功能，如跨域资源共享(CORS)、拦截器、静态资源访问等。 通过实现WebMvcConfigurer接口，可以自定义Spring MVC的各种配置。
 */
@Configuration
public class WebConfig implements WebMvcConfigurer {
   ...
   * 配置跨域资源共享(CORS)
   *
   * <p>允许前端应用从不同源访问API，解决浏览器的同源策略限制。 当前配置允许所有来源、所有方法和所有头信息的跨域请求。 在生产环境中，应该根据实际需求限制来源和方法，提高安全性。
   *
